module.exports = function(context, msg, matches) {
	...
	if (!context.isReserved(label) && phrase.charAt(0) != '@' && label != firstName && label != username && (!context.utils.contains(context.permanentCommands, label) || context.utils.contains(context.adminPowers, username))) {
