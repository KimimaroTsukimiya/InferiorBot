...
manager.addCommand(/^\/lista(@inferiorbot)? (frase|voz|video|imagem|sticker|texto)? (.+)?$/i, '/lista <frase|voz|video|imagem|sticker|texto> <palavra-chave> - Lista os rótulos salvos.', require('./commands/list'));
manager.init();
