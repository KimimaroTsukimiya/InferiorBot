...
manager.addCommand(/^\/lista(@inferiorbot)?(\s+frase|voz|video|imagem|sticker|texto)?(\s+.+)?$/i, '/lista <tudo|frase|voz|video|imagem|sticker|texto> <palavra-chave> - Lista os rótulos salvos.', require('./commands/list'));
manager.init();
